...
void CMyService::ShowHelp()
{
  ...
  _tprintf(_T("Usage: %s[-install | -uninstall | -remove | -start | -pause | -continue | -stop | -help | -? ]\n\
\n\
...
/ remove | / uninstall          Uninstalls the service.\n\
/ start                         Starts the service.\n\
/ stop                          Stops the service.\n\
/ pause                         Pauses the service.\n\
/ continue                      Continues the service.\n\
/ auto                          Installs the service as an automatic start - up\n\
                                service, as opposed to a manual start - up \n\
                                service which is the default \n\
                                (should be used in conjunction with the \n\
                                / install argument).\n\
/ debug | / app | / Application Using this setting bypasses the service SCM \n\
                                start - up code and instead runs your code as a\n\
                                standard application.\n\
/ help[/ ? ]                    Calls the virtual CNTService::OnHelp function.\n\
/ T:value                       A timeout value in milliseconds to use when \n\
                                uninstalling, starting, stopping, pausing and \n\
                                continuing the service.\n\
/ SCL : XYZ                     Provides the command line which the code should\n\
                                use when running as a service by the SCM. \n\
                                (The use of this value on the command line is \n\
                                dependent upon \n\
                                CNTService::m_bAllowCommandLine).\n\
/ SD : WYZ                      Provides the service description to use. \n\
                                (The use of this value on the command line is \n\
                                dependent upon \n\
                                CNTService::m_bAllowDescriptionChange).\n\
/ SDN : PRQ                     Provides the service display name to use. \n\
                                (The use of this value on the command line is \n\
                                dependent upon \n\
                                CNTService::m_bAllowDisplayNameChange).\n\
/ SN : STU                      Provides the service name to use. \n\
                                (The use of this value on the command line is \n\
                                dependent upon CNTService::m_bAllowNameChange).\n\
/ U : ABC                       Allows you to configure the username account \n\
                                under which the service runs.\n\
/ P : DEF                       Allows you to configure the password for the \n\
                                associated username account under which the \n\
                                service runs.\n\
/ silent                        Use this command line in conjunction with other\n\
                                command line arguments to suppress any message \n\
                                boxes or console output which the framework \n\
                                generates.\n\
                                                 "), __targv[0]);
}
