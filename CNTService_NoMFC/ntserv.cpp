...
CNTService::CNTService(LPCTSTR lpszServiceName, LPCTSTR lpszDisplayName, DWORD dwControlsAccepted, LPCTSTR lpszDescription) : m_lpfnRegisterServiceCtrlHandlerEx(NULL)
{
  ...
  err = _tsplitpath_s(tzFileName, tzDrive, _MAX_DRIVE, tzDir, _MAX_DIR,
      tzFname, _MAX_FNAME, tzExt, _MAX_EXT);

  SetServiceName(tzFname);
  SetDisplayName(tzFname);
  SetDescription(tzFname);
#endif
  //////////////////////////////////////////////////////////////////////////
}
